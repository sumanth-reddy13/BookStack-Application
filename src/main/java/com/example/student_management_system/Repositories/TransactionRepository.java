...
public interface TransactionRepository extends JpaRepository<Transaction, Integer> {
    ...
    @Query(value = "select * from transactions where card_id=:cardId and book_id=:bookId and is_issued_operation=true", nativeQuery = true)
    List<Transaction> getTransactionForBookAndCard(int cardId, int bookId);
